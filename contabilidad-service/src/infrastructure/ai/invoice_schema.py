...
_INVOICE_RULES = (
    ...
    "Montos: número puro sin símbolo $, CON centavos si la factura los trae. "
    "NUNCA redondees al peso: si dice 83.999,99 → 83999.99 (no 84000).\n"
    "Ejemplos OBLIGATORIOS:\n"
    "- '14,300.00' o '2,500.00' (coma=miles, punto=decimal) → 14300 / 2500. NUNCA 143000.\n"
    "- '14.300,00' o '14.300' (punto=miles, coma=decimal) → 14300.\n"
    "- '83.999,99' (CO) → 83999.99. Conserva los dos decimales.\n"
    "- '119.000' (CO) → 119000. No multipliques por 10 ni quites el decimal mal.\n"
    "NUMERO DE FACTURA (crítico):\n"
    "- Usa SOLO el número/folio/consecutivo de la FACTURA (ej. FPFL-18121030, "
    "FPOS-16488, FE-2045, FV 12345, CDC-…).\n"
    "- NUNCA uses TURNO, caja, mesa, puesto, taquilla, ticket de atención, "
    "ni 'No. de turno' como numero_factura.\n"
    "- Si ves 'Turno: 12' y 'Factura FPFL-18121030', numero_factura = FPFL-18121030.\n"
    "- Prefiere prefijos FPFL/FPOS/FE/FV/CDC/FAC/INV con consecutivo largo.\n"
    "Busca: NIT/CC/RUT/Tax ID, CUFE, FPOS/FPFL/FE/FV/CDC, razón social, "
